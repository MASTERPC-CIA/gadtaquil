...
<div id="page-wrapper"><div id="page">
  ...
  <div id="header"><div class="section">
		...
		<?php if (theme_get_setting('social_links', 'professional_pro')): ?>
          <div class="social-icons">
           <ul>
            <li><a href="<?php print $front_page; ?>/rss.xml"><img src="<?php print base_path() . drupal_get_path('theme', 'professional_pro') . '/images/rss.png'; ?>" alt="RSS Feed"/></a></li>
            <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 'professional_pro'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'professional_pro') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
            <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username', 'professional_pro'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'professional_pro') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
           </ul>
          </div>
        <?php endif; ?>
  ...
  <div id="main-wrapper" class="clearfix"><div id="main" class="clearfix">
  		...
  		<?php if($is_front): ?><div id="slideshow"><?php print render($page['slideshow']); ?></div>	
	...
	<div id="footer-wrapper"><div class="section">
		...
		<div id="developed" style="text-align: right"><?php print t('Sitio desaroolado por Master PC'); ?>  <a href="http://www.zymphonies.com/">Zymphonies</a>

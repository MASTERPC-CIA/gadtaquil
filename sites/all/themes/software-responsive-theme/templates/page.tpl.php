  ...
  <div id="container">
    <div class="container-wrap">
      <div class="content-sidebar-wrap">
        <div id="content">
          <?php if (theme_get_setting('breadcrumbs', 'software')): ?><div id="breadcrumbs"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
...
<div id="footer">
  ...
  <!-- Social Links -->
  <?php if (theme_get_setting('social_links', 'software')): ?>
    <div class="social-icons">
     <ul>
      <!--<li><a class="rss" href="<?php print $front_page; ?>rss.xml"><i class="fa fa-rss"></i></a></li>-->
      <li><a class="fb" href="<?php echo theme_get_setting('facebook_profile_url', 'software'); ?>" target="_blank" rel="me"><i class="fa fa-facebook"></i></a></li>
      <li><a class="twitter" href="<?php echo theme_get_setting('twitter_profile_url', 'software'); ?>" target="_blank" rel="me"><i class="fa fa-twitter"></i></a></li>
      ...
      <!--<li><a class="youtube" href="<?php echo theme_get_setting('youtube_profile_url', 'software'); ?>" target="_blank" rel="me"><i class="fa fa-youtube"></i></a></li>-->
     </ul>
    </div>
  <?php endif; ?>
      
    <div id="copyright">
      <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?> </p> <p class="credits"> <?php print t('Sitio web desarrollado por: '); ?>  <a href="http://shopping.billingsof.com/masterpc/">Master PC</a></p>
      <div class="clear"></div>
    </div>
  </div>
